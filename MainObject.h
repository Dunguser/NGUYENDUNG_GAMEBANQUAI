...
public:
    ...
    void set_solantrungdan ( int a ) { solantrungdan = a ;}

    bool biandan = false;
    void setbitrungdan ( bool k) { biandan = k;}
    bool getandan() { return biandan ;}

    int get_width_frame () const { return width_frame_ ; }
    int get_height_frame () const { return height_frame_ ; }

    void set_vitri_nvc ( int a , int b){ x_now_pos = a ; y_now_pos = b;}
