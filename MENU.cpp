...
int MENU::showmenu(SDL_Renderer* des)
{
    bool ret = LoadImage("IMG/botro/menu1.png", des); // load anh menu o day
    if (ret == false)
    {
        cout << SDL_GetError();
        return -3333;
    ...
    vitriluachon[0].x = 565 ;
    vitriluachon[0].y = 345;
    vitriluachon[1].x = 565 ;
    vitriluachon[1].y = 470;
    vitriluachon[2].x = 565;
    vitriluachon[2].y = 600;
